...
pushd ${src_dir}
    ...
    pushd binutils-gdb
        ...
        mkdir build-2870b1b
        cd build-2870b1b
        ../configure --prefix=${dst_dir}/binutils-2870b1b --target=x86_64-mingw32 --disable-shared --disable-gdb --disable-libdecnumber --disable-readline --disable-sim --disable-gprofng --disable-werror
        make -j"${jobs}"
        sudo make install
    popd
    ...
    pushd binutils-gdb
        ...
        mkdir build-53f7e8e
        cd build-53f7e8e
        ../configure --prefix=${dst_dir}/binutils-53f7e8e --disable-shared --disable-gdb --disable-libdecnumber --disable-readline --disable-sim --disable-gprofng --disable-werror
        make -j"${jobs}"
        sudo make install
    popd
    ...
    pushd binutils-gdb
        ...
        mkdir build-a6c21d4
        cd build-a6c21d4
        ../configure --prefix=${dst_dir}/binutils-a6c21d4 --target=x86_64-linux --disable-shared --disable-gdb --disable-libdecnumber --disable-readline --disable-sim --disable-gprofng --disable-werror
        make -j"${jobs}"
        sudo make install
    popd
    ...
    pushd binutils-gdb
        ...
        mkdir build-be8e831
        cd build-be8e831
        ../configure --prefix=${dst_dir}/binutils-be8e831 --target=x86_64-linux --disable-shared --disable-gdb --disable-libdecnumber --disable-readline --disable-sim --disable-gprofng --disable-werror
        make -j"${jobs}"
        sudo make install
    popd
    ...
    pushd valgrind
        ...
        ./autogen.sh
        ./configure --prefix=${dst_dir}/valgrind-d97fed7
        make -j"${jobs}"
        sudo make install
    popd
    ...
    pushd valgrind
        ...
        ./autogen.sh
        ./configure --prefix=${dst_dir}/valgrind-bd4db67
        make -j"${jobs}"
        sudo make install
    popd
    ...
    pushd valgrind
        ...
        ./autogen.sh
        ./configure --prefix=${dst_dir}/valgrind-49dccaf
        make -j"${jobs}"
        sudo make install
    popd
    ...
    pushd valgrind
        ...
        ./autogen.sh
        ./configure --prefix=${dst_dir}/valgrind-fcdaa47
        make -j"${jobs}"
        sudo make install
    popd
